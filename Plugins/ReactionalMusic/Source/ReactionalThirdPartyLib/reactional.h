...
/**
 * @brief Starts the track and theme, ensured to run on the same thread.
 * @param engine The engine.
 */
REACTIONAL_PUB int reactional_start(void *engine);
 ...
 * if quant is 4'000'000 and phase is 1'000'000 the function will return the beat position of
 * the 2nd beat in the next bar (if the bar is 4'000'000 beats long).
 */
